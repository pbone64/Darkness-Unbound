...
{
	public class SharpBranchPro : ModProjectile
	{
		public override string Texture => "DarknessUnbound/Items/Weapons/Throwing/Unconsumable/SharpBranch";
		...
		public override void Kill(int timeLeft)
		{
			...
			{
				// Create a new dust
				Dust dust = Dust.NewDustDirect(usePos, projectile.width, projectile.height, 40);
